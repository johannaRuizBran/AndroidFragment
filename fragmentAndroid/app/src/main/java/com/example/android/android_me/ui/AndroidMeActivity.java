...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            /*es esta parte del codigo estoy creando al fragment el cual será inflado con la imagen
        * a la cual se setea en la lista*/
            BodyPartFragment headFragment= new BodyPartFragment();
            headFragment.setmImageIds(AndroidImageAssets.getHeads());
            headFragment.setmListIndex(1);

        /*es esta parte se inserta nuestro fragment a la vista de android me activity*/
